  ...
  return (
    <View>
          ...
          .map((item) =>
            item.properties.map((property, index) => (
              <PropertyCard
                ...
                childred={route.params.childred}
      ...
      <BottomModal
        ...
        modalTitle={<ModalTitle title="Sort & Filter" />}
        footer={
          <ModalFooter>
            <ModalButton
              text="Apply"
              ...
              onPress={() => searchPlaces(selectedRadio)}
            />
          </ModalFooter>
        }
        modalAnimation={
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 3 }}>
            ...
            >
              {selectedRadio === 0 ? (
                <FontAwesome name="circle" size={23} color="#003580" />
              ) : (
                <Entypo name="circle" size={20} color="#003580" />
              )}
